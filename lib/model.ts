...
export const rowSchema = productSchema.extend({ weight: z.string(), price: z.string(), margin: z.string().default('0'), currency: z.enum(currencies), leadTime: z.string() });
